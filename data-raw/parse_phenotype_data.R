   ...
   # names(tcga_pancan_samples)
     tcga_pancan_samples$quality  # A tibble: 67,880 x 17
   ...
   ## ::::::::::::::::::::::::
   pdata <- as_tibble(tcga_pancan_samples$quality) %>% # A tibble: 67,880 x 50
   ...
   pdata[pdata$cancer.type=="",] # 10 samples have missing cancer.type, remove these ## Note: Fix #1 20191015, already performed in re-parsing of panCan tables
   pdata <- pdata %>%
   ...
   pdata <- pdata %>% # A tibble: 67,880 x 51
   ...
   cibersort <- tcga_pancan_samples$cibersort # A tibble: 11,216 x 34
   ...
   Hmisc::describe(cibersort) # A tibble: 11,216 x 34
   cibersort <- cibersort %>% filter(!is.na(sample_id))
   table(duplicated(cibersort$sample_id)) ## 9 duplicated sample ids - remove these
   cibersort <- cibersort[!duplicated(cibersort$sample_id), ] # A tibble: 11,207 x 34
   ...
   pdata <- dplyr::left_join(pdata, pdata_chen[,chen_cols], by="sample_id") # A tibble: 67,880 x 115
   pdata
   ...
   table(pdata$TP53)
   str(pdata) # Classes ‘tbl_df’, ‘tbl’ and 'data.frame':	67880 obs. of  115 variables:
   # Hmisc::describe(pdata)
   ...
   str(pdata) # Classes ‘tbl_df’, ‘tbl’ and 'data.frame':	67880 obs. of  123 variables:
   ...
   pdata <- pdata %>%
      ...
      # A tibble: 67,880 x 125

   table(pdata$taxonomy_published)
   table(pdata$sample_type2)
                         # ACC-NB                        ACC-NT                        ACC-TP                       BLCA-NB                       BLCA-NT                       BLCA-TM
                         #      85                             5                           375                           461                           115                             3
                         # BLCA-TP                    BRCA-CELLC                       BRCA-NB                       BRCA-NT                       BRCA-TM                       BRCA-TP
                         #    2114                            32                          1003                           523                            33                          5316
                         # CESC-NB                       CESC-NT                       CESC-TM                       CESC-TP                       CHOL-NB                       CHOL-NT
                         #     330                            19                             8                          1389                            34                            42
                         # CHOL-TP                       COAD-NB                       COAD-NT                       COAD-TM                       COAD-TP                       COAD-TR
                         #     174                           436                           228                             6                          2348                             4
                         # DLBC-NB DLBC-NBM,\tBone Marrow Normal                       DLBC-TP                       ESCA-NB                       ESCA-NT                       ESCA-TM
                         #      46                             4                           224                           159                           122                             4
                         # ESCA-TP                       FPPP-TP                        GBM-NB                        GBM-NT                        GBM-TP                        GBM-TR
                         #     897                            45                           501                            38                          1422                            50
                         # HNSC-NB                       HNSC-NT                       HNSC-TM                       HNSC-TP                       KICH-NB                       KICH-NT
                         #     591                           230                             8                          2560                             9                           107
                         # KICH-TP                       KIRC-NB                       KIRC-NT                      KIRC-TAP                       KIRC-TP                       KIRP-NB
                         #     327                           112                           922                             4                          2678                           219
                         # KIRP-NT                      KIRP-TAP                       KIRP-TP                       LAML-NT                       LAML-TB                        LGG-NB
                         #     201                             4                          1405                           195                           946                           538
                         # LGG-NBC                        LGG-TP                        LGG-TR                       LIHC-NB                       LIHC-NT                       LIHC-TP
                         #       2                          2538                            78                           305                           234                          1675
                         # LIHC-TR                       LUAD-NB                       LUAD-NT                       LUAD-TP                       LUAD-TR                       LUSC-NB
                         #      12                           485                           395                          2668                             8                           297
                         # LUSC-NT                       LUSC-TP                       MESO-NB                       MESO-NT                       MESO-TP                         OV-NB
                         #     405                          2336                            85                             1                           474                           442
                         #   OV-NT                         OV-TP                         OV-TR                       PAAD-NB                       PAAD-NT                       PAAD-TM
                         #     142                          2382                            62                           146                            55                             4
                         # PAAD-TP                       PCPG-NB                       PCPG-NT                      PCPG-TAP                       PCPG-TM                       PCPG-TP
                         #     847                           175                            14                            13                            10                           791
                         # PRAD-NB                       PRAD-NT                       PRAD-TM                       PRAD-TP                       READ-NB                       READ-NT
                         #     526                           279                             4                          2462                           164                            46
                         # READ-TP                       READ-TR                       SARC-NB                       SARC-NT                       SARC-TM                       SARC-TP
                         #     828                             5                           233                            28                             4                          1263
                         # SARC-TR                       SKCM-NB                       SKCM-NT                      SKCM-TAM                       SKCM-TM                       SKCM-TP
                         #      15                           585                             7                             4                          1824                           522
                         # STAD-NB                       STAD-NT                       STAD-TP                       TGCT-NB                      TGCT-TAP                       TGCT-TP
                         #     440                           307                          2355                           148                            28                           718
                         # THCA-NB                       THCA-NT                       THCA-TM                       THCA-TP                       THYM-NB                      THYM-NBC
                         #     511                           284                            35                          2496                           111                             2
                         # THYM-NT                       THYM-TP                       UCEC-NB                       UCEC-NT                       UCEC-TP                       UCEC-TR
                         #      18                           581                           611                           167                          2740                             4
                         #  UCS-NB                        UCS-NT                        UCS-TP                        UVM-NB                        UVM-TP
                         #      49                             6                           275                           131                           332
   pdata_step2 <- pdata
   ...
   pdata3 <- pdata2 %>%
      ...
      mutate(tax_simp2 = if_else(taxonomy_published %in% c("crtx","crtmed","med","infl1","infl2"), as.character(taxonomy_published), tax_simp2)) %>%
      mutate(tax_simp2 = factor(tax_simp2, levels=c("crtx","crtmed","med","infl1","infl2",
            #"kidney_n",
            "ccRCC_a", "ccRCC_b1", "ccRCC_b2", "ccRCC_c",
